...
class MeshDrawer {
	...
	constructor() {
    	...
    	this.lightOnLoc = gl.getUniformLocation(this.prog, 'enableLighting');
	...
	enableLighting(show) {
		 ...
		 */
		gl.useProgram(this.prog);
    	gl.uniform1i(this.lightOnLoc, show);
	}
...
const meshFS = `
    ...
    void main() {
        ...
        vec4 baseColor = showTex ? texColor : vec4(1.0, 0.0, 0.0, 1.0);
